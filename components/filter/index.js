...
function (_React$Component) {
  ...
  function Filter(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getCustomPopoverProps", function (_ref) {
       ...
       */
      var popoverBody = _react.default.createElement("div", null, _react.default.createElement("h4", {
        className: "slds-assistive-text",
        id: "".concat(_this.getId(), "-popover-heading")
      }, assistiveText.editFilterHeading), _this.props.children, _react.default.createElement("div", {
    ...
    (0, _checkProps.default)(_constants.FILTER, _component.default);
    return _this;
  }
  ...
  _createClass(Filter, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
      ...
      }, !this.props.isLocked && (this.props.children || this.props.popover) ? _react.default.createElement(_popover.default, popoverProps, _react.default.createElement("button", {
        ...
        className: "slds-assistive-text"
      }, assistiveText.editFilter), this.props.property ? _react.default.createElement("p", {
        className: "slds-text-body_small"
      }, this.props.property) : null, _react.default.createElement("p", null, this.props.predicate))) : _react.default.createElement("button", {
        "aria-describedby": this.props.isError ? "".concat(this.getId(), "-error") : undefined,
        className: "slds-button_reset slds-grow slds-has-blur-focus",
        disabled: true,
        type: "button"
        ...
        className: "slds-text-body_small"
      }, this.props.property), _react.default.createElement("p", null, this.props.predicate)), // Remove button
      !this.props.isPermanent && !this.props.isLocked ? _react.default.createElement(_button.default, {
        assistiveText: {

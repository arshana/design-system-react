...
function (_React$Component) {
  ...
  _createClass(SplitView, [{
    ...
    value: function masterContent() {
      return this.state.isOpen ? _react.default.createElement("article", {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        ariaControls: this.state.isOpen ? this.getMasterViewId() : undefined,
        isOpen: this.state.isOpen,
        events: {
      ...
      }), this.masterContent()), _react.default.createElement("div", {
        style: {

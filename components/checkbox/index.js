  ...
  function Checkbox(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderBaseVariant", function (props, assistiveText, labels) {
      return _react.default.createElement("div", {
        ...
        title: "required"
      }, '*') : null, _react.default.createElement("input", _extends({
        "aria-controls": _this.props['aria-controls'],
        "aria-describedby": _this.getAriaDescribedBy(),
        "aria-labelledby": _this.props['aria-labelledby'],
        "aria-owns": _this.props['aria-owns'],
    ...
    _defineProperty(_assertThisInitialized(_this), "renderToggleVariant", function (props, assistiveText, labels) {
      return _react.default.createElement("div", {
        ...
        className: "slds-assistive-text"
      }, assistiveText.label) : null, _react.default.createElement("input", _extends({
        "aria-controls": _this.props['aria-controls'],
        "aria-describedby": _this.getAriaDescribedBy({
    ...
    _defineProperty(_assertThisInitialized(_this), "renderVisualPickerVariant", function (props, assistiveText) {
      return _react.default.createElement("span", {
        ...
        className: "slds-checkbox_button__label",
        htmlFor: _this.getId()
      }, _this.props.coverable ? _react.default.createElement("div", {
        className: "slds-visual-picker__figure slds-visual-picker__icon slds-align_absolute-center"
      }, _react.default.createElement("span", {
        className: "slds-is-selected"
      }, _this.props.onRenderVisualPickerSelected()), _react.default.createElement("span", {
        className: "slds-is-not-selected"
      }, _this.props.onRenderVisualPickerNotSelected())) : _react.default.createElement("span", {
        className: "slds-visual-picker__figure slds-visual-picker__text slds-align_absolute-center"
      }, _this.props.onRenderVisualPicker()), !_this.props.vertical ? _react.default.createElement("span", {
        className: "slds-visual-picker__body"
      }, _this.props.labels.heading ? _react.default.createElement("span", {
        className: "slds-text-heading_small"
      }, _this.props.labels.heading) : null, _react.default.createElement("span", {
        className: "slds-text-title"
      }, _this.props.labels.label), assistiveText.label || assistiveText.heading ? _react.default.createElement("span", {
        className: "slds-assistive-text"
      }, assistiveText.label || assistiveText.heading) : null) : null, !_this.props.coverable ? _react.default.createElement("span", {
